...
class Application:
    def __init__(self) -> None:
        ...
        self._background_image = pygame.image.load('battleship.jpg').convert()
        self._background_image = pygame.transform.scale(self._background_image, (WIDTH, HEIGHT))
    ...
    def draw_window(self, text: str) -> None:
        self._WINDOW.blit(self._background_image, (0, 0))
